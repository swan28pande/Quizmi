...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-950 flex flex-col items-center">
      ...
      >
        {!hasSearched ? (
          <h1 className="text-5xl md:text-6xl font-extrabold text-white drop-shadow mb-4 tracking-tight select-none">
            Quizmi
          </h1>
        ) : (
          <>
            ...
            <span
              className="fixed top-10 left-0 pl-6 text-2xl md:text-4xl font-extrabold select-none z-50"
              style={{ color: "#EEFC7C", fontFamily: "FK Grotesk, sans-serif" }}
            >
              Quizmi
            </span>
          </>
        ...
        {!hasSearched ? (
          ...
          >
            <div className="flex w-full bg-gray-800 rounded-none shadow-xl overflow-hidden border border-gray-700 transition duration-300 ease-in-out mb-2">
              <label className="flex items-center cursor-pointer px-3" title="Attach PDF">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="#EEFC7C" className="w-6 h-6">
              ...
              <input
                ...
                style={{ borderColor: "#EEFC7C", borderWidth: "2px" }}
                placeholder="Type a topic or upload slides for a quiz"
                onChange={handleInput}
                value={query}
                onKeyDown={handleEnter}
              />
              <button
                style={{ backgroundColor: "#EEFC7C", color: "#222", cursor: 'pointer' }}
          ...
          <div className="fixed top-10 right-10 z-50 flex items-center gap-4">
            <button
              style={{ backgroundColor: '#EEFC7C', color: '#222', fontWeight: 700, fontFamily: 'FK Grotesk, sans-serif', fontSize: '0.85rem', padding: '0.25rem 0.6rem', cursor: 'pointer' }}
